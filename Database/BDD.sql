...
ALTER TABLE `GROUP` ADD CONSTRAINT `UTILISER` FOREIGN KEY () REFERENCES `GROUP_MSG` ();
ALTER TABLE `GROUP` ADD CONSTRAINT `APELLER_copy_1` FOREIGN KEY () REFERENCES `VISIO_GROUP` ();
ALTER TABLE `UTILISATEUR` ADD CONSTRAINT `       ENVOYER` FOREIGN KEY () REFERENCES `PERSONAL_MSG` ();
ALTER TABLE `UTILISATEUR` ADD CONSTRAINT `ENVOYER` FOREIGN KEY () REFERENCES `GROUP_MSG` ();
ALTER TABLE `UTILISATEUR` ADD CONSTRAINT `APELLER` FOREIGN KEY () REFERENCES `USER_TO_USER` ();
ALTER TABLE `UTILISATEUR` ADD CONSTRAINT `CRÉER` FOREIGN KEY () REFERENCES `RÉUNION` ();
