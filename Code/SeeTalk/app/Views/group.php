                ...
                <form action="#" method="POST">
                    ...
                    <div class="ajouter">
                        <div class="add_member">
                            ...
                            <div>Nicolas Daunac</div>
                            <div>Lucas Sanhes</div>
                            <div>Guillaume Vern</div>
                            <div>Maxime Curtil</div>
                        </div>
                        <input type="submit" class="submit submit-button" value="Créer le groupe">
                    </div>
                </form>
